...
#---------------------------------------------------#
WindowTitle = 'Green Brick Chat v1.0 - Client'
HOST = "94.189.151.32"
PORT = 8011
...
SendButton = Button(base, font=30, text="Send", width="12", height=5,
                    bd=0, bg="green", activebackground="white",
                    command=ClickAction)

#Create the Button to nudge
NudgeButton = Button(base, font=30, text="Nudge", width="12", height=5,
                     bd=0, bg="red", activebackground="white",
                     command=Nudge)
...
NudgeButton.place(x=50, y=401, height=90)
